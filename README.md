This project implements VSGL for graph property detection. It includes dataset preprocessing, model definition and training, evaluation, and utility functions to streamline the workflow.
